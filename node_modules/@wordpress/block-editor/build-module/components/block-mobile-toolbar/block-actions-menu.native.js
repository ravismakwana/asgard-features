  ...
  const allOptions = {
    ...
    convertToRegularBlocks: {
      ...
      onSelect: () => {
        ...
        __('%s converted to regular blocks'), (reusableBlock === null || reusableBlock === void 0 ? void 0 : (_reusableBlock$title = reusableBlock.title) === null || _reusableBlock$title === void 0 ? void 0 : _reusableBlock$title.raw) || blockTitle));
        convertToRegularBlocks();
      }
    }
  };
...
export default compose(withSelect((select, _ref2) => {
  ...
  const selectedBlock = selectedBlockClientId ? first(getBlocksByClientId(selectedBlockClientId)) : undefined;
