...
const getGlobalBlockCount = (0, _rememo.default)((state, blockName) => {
  ...
  return (0, _lodash.reduce)(clientIds, (accumulator, clientId) => {
    const block = state.blocks.byClientId[clientId];
...
const getBlockParentsByBlockName = (0, _rememo.default)(function (state, clientId, blockName) {
  ...
  return (0, _lodash.map)((0, _lodash.filter)((0, _lodash.map)(parents, id => ({
    id,
...
function hasSelectedInnerBlock(state, clientId) {
  ...
  return (0, _lodash.some)(getBlockOrder(state, clientId), innerClientId => isBlockSelected(state, innerClientId) || isBlockMultiSelected(state, innerClientId) || deep && hasSelectedInnerBlock(state, innerClientId, deep));
}
/**
 * Returns true if the block corresponding to the specified client ID is
...
function isAncestorBeingDragged(state, clientId) {
  ...
  return (0, _lodash.some)(parents, parentClientId => isBlockBeingDragged(state, parentClientId));
}
/**
...
const canInsertBlockType = (0, _rememo.default)(canInsertBlockTypeUnmemoized, (state, blockName, rootClientId) => [state.blockListSettings[rootClientId], state.blocks.byClientId[rootClientId], state.settings.allowedBlockTypes, state.settings.templateLock]);
/**
...
const hasInserterItems = (0, _rememo.default)(function (state) {
  let rootClientId = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
  const hasBlockType = (0, _lodash.some)((0, _blocks.getBlockTypes)(), blockType => canIncludeBlockTypeInInserter(state, blockType, rootClientId));
...
const __experimentalGetAllowedBlocks = (0, _rememo.default)(function (state) {
  ...
  return (0, _lodash.filter)((0, _blocks.getBlockTypes)(), blockType => canIncludeBlockTypeInInserter(state, blockType, rootClientId));
...
const checkAllowListRecursive = (blocks, allowedBlockTypes) => {
  if ((0, _lodash.isBoolean)(allowedBlockTypes)) {
...
const __experimentalGetReusableBlockTitle = (0, _rememo.default)((state, ref) => {
  ...
  const reusableBlock = (0, _lodash.find)(getReusableBlocks(state), block => block.id === ref);
