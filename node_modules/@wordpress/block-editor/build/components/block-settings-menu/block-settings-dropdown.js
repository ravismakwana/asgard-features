...
function BlockSettingsDropdown(_ref2) {
  ...
  } : _lodash.noop, [__experimentalSelectBlock, previousBlockClientId, nextBlockClientId, selectedBlockClientIds]);
  ...
  return (0, _element.createElement)(_blockActions.default, {
    ...
    return (0, _element.createElement)(_components.DropdownMenu, (0, _extends2.default)({
      ...
      }), firstParentClientId !== undefined && (0, _element.createElement)(_components.MenuItem, (0, _extends2.default)({}, showParentOutlineGestures, {
        ref: selectParentButtonRef,
      ...
      (0, _i18n.__)('Select parent block (%s)'), parentBlockType.title)), count === 1 && (0, _element.createElement)(_blockHtmlConvertButton.default, {
        ...
        onClick: (0, _lodash.flow)(onClose, onDuplicate, updateSelectionAfterDuplicate),
        ...
        onClick: (0, _lodash.flow)(onClose, onRemove, updateSelectionAfterRemove),
