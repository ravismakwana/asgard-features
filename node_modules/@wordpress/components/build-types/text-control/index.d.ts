 ...
 * ```
 */
export declare const TextControl: import("react").ForwardRefExoticComponent<Pick<Pick<import("../base-control/types").BaseControlProps, "label" | "className" | "help" | "hideLabelFromVision"> & {
