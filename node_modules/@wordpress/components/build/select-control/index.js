...
function UnforwardedSelectControl(_ref, ref) {
  ...
  if ((0, _lodash.isEmpty)(options) && !children) return null;
  ...
  return (0, _element.createElement)(_baseControl.default, {
    ...
    label: label,
    size: size,
    suffix: suffix || (0, _element.createElement)(_selectControlStyles.DownArrowWrapper, null, (0, _element.createElement)(_icons.Icon, {
