(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('tslib'), require('react'), require('normalize-wheel')) :
  typeof define === 'function' && define.amd ? define(['tslib', 'react', 'normalize-wheel'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.ReactEasyCrop = factory(global.tslib, global.React, global.normalizeWheel));
}(this, (function (tslib, React, normalizeWheel) { 'use strict';
